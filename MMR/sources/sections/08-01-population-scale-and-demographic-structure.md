## 8.1 Population Size, Growth, Age Structure, and Dependency
`n`n
...
| Population, male | `SP.POP.TOTL.MA.ZS` | 2024 | 49.8 | percent of total population (%) | -0.1 |

| Population growth | `SP.POP.GROW` | 2024 | 0.7 | annual percent (%) | -0.2 |

| Fertility rate, total | `SP.DYN.TFRT.IN` | 2024 | 2.1 | births per woman | -0.2 |

| Population ages 0-14 | `SP.POP.0014.TO.ZS` | 2024 | 24.3 | percent of total population (%) | -2.5 |

| Population ages 65 and above | `SP.POP.65UP.TO.ZS` | 2024 | 7.3 | percent of total population (%) | 1.8 |

| Age dependency ratio, young | `SP.POP.DPND.YG` | 2024 | 35.5 | per 100 working-age population | -4.1 |

| Age dependency ratio, old | `SP.POP.DPND.OL` | 2024 | 10.7 | per 100 working-age population | 2.6 |
